...
__export(imagen_exports, {
  ACTUAL_IMAGEN_MODELS: () => ACTUAL_IMAGEN_MODELS,
...
const ACTUAL_IMAGEN_MODELS = {
  "imagen-3.0-generate-001": (0, import_model.modelRef)({
  ...
  "imagen-3.0-fast-generate-001": (0, import_model.modelRef)({
...
function defineImagenModel(ai, name, client, options) {
  ...
  const model = SUPPORTED_IMAGEN_MODELS[name] || (0, import_model.modelRef)({
    name: modelName,
    info: {
      ...GENERIC_IMAGEN_INFO,
